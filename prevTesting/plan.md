...
4) Переработать систему обновления:  
   1. Перенести все обновление в отдельную систему `updateLord`. Что надо перенести: ✔
      ...
      2. ✗ Обновление счетчика выделенных и живых дварфов и клеток ✗ (найденые лучшие решения: статы дварфов перенесены в entities.c, статы клеток перенесены в выделения)
