...
4) Переработать систему обновления:  
   ...
   - Основная сложность будет в том, что функции для обновления разных вещей нужно будет как-то связать, иначе придется каждый раз проходить по всему массиву дварфов отдельно для обновления их самих, отдельно для обновления `dwarves_alive` и т. д. ✗
